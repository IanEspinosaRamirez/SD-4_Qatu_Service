...
using Application.Queries.OrderDetail.GetById;
using Application.Queries.OrderDetail.GetPaged;
using MediatR;
...
public class OrderDetailController : ApiController
{
    ...
    {
        var getStoreResult = await _mediator.Send(new GetByIdOrderDetailQuery(id));
