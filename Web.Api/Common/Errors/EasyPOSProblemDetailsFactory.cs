...
public class EasyPOSProblemDetailsFactory : ProblemDetailsFactory {
  ...
  public override ProblemDetails CreateProblemDetails(
    ...
    var problemDetails =
        new ProblemDetails { Status = statusCode, Title = title, Type = type,
  ...
  private void ApplyProblemDetailsDefaults(HttpContext httpContext,
    ...
    if (_options.ClientErrorMapping.TryGetValue(statusCode,
    ...
    if (httpContext.Items.TryGetValue(HttpContextItemKeys.Errors,
                                      out var errorsObj) &&
        errorsObj is List<Error> errors && errors.Any()) {
